...
const Header = ({ setCategory, setSearchQuery }) => {
  ...
  return (
    <div className="bg-primary w-full">
      <header className=" text-white px-2 md:px-6 py-3 md:py-5 flex justify-between items-center w-11/12 max-w-[1200px] mx-auto sticky top-0 left-0 z-50 shadow-2xl">
